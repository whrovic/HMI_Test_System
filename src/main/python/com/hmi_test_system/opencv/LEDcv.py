...
from main.python.com.hmi_test_system.data.color.color import OffColor, UnknownColor
from main.python.com.hmi_test_system.data.color.list_of_colors import ListOfColors
